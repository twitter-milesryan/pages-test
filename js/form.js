...
/***/ "../content/jcr_root/apps/boilerplate-twitter/components/form/f01-form/webpack/index.js":
...
__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/form/f01-form/webpack/index.scss");

var _aem = __webpack_require__("./source/aem.js");

var _validateEmail = __webpack_require__("./source/core/js/validate-email/index.js");

var _validateEmail2 = _interopRequireDefault(_validateEmail);

var _twitterText = __webpack_require__("./node_modules/twitter-text/twitter-text.js");

var _twitterText2 = _interopRequireDefault(_twitterText);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var F01Form = function () {
  function F01Form(element, attributes) {
    (0, _classCallCheck3.default)(this, F01Form);

    this.element = element;
    this.form = element.querySelector('form');
    this.formWrapper = element.querySelector('.f01__form-wrapper');
    this.successWrapper = element.querySelector('.f01__success-wrapper');
    this.alertWrapper = element.querySelector('.f01__alert-wrapper');
    this.submit = element.querySelector('.f01__submit-button');
    this.submitUrl = attributes.submitUrl;
    this.customValidationFields = [].concat((0, _toConsumableArray3.default)(document.querySelectorAll('.has-validation'))); // Twitter/email
    this.requiredValidationFields = [].concat((0, _toConsumableArray3.default)(document.querySelectorAll('.is-required')));
    this.isValid = true;
   ...
   * We're checking if all required fields have been filled out (at least 1 character),
   * and if fields that require Twitter handle or email address are valid.
   */


  (0, _createClass3.default)(F01Form, [{
    key: 'validateFields',
    value: function validateFields() {
      ...
      this.requiredValidationFields.forEach(function (field) {
        var requiredField = field.classList.contains('f04') ? field.querySelector('input') : field.querySelector('textarea');
        var fieldClass = field.classList.contains('f04') ? '.f04__field' : '.f05__textarea';

        if (requiredField.value.length > 0) {
          // valid
          // Handle text fields
          if (fieldClass === '.f04__field' && field.querySelector(fieldClass).classList.contains('is-required')) {
            field.querySelector(fieldClass).classList.remove('is-required');
          }

          // Handle textarea fields. Placeholder text inside of a textarea is the value
          // of the field, which means the length of the value is > 0. We'll need to check
          // and see if the placeholder text has changed or not.
          if (fieldClass == '.f05__textarea' && requiredField.classList.contains('has-placeholder')) {
            if (requiredField.value !== requiredField.dataset.placeholder) {
              // valid
              if (field.querySelector(fieldClass).classList.contains('is-required')) {
                field.querySelector(fieldClass).classList.remove('is-required');
              }
            } else {
              // not valid
              _this.isValid = false;
              if (!field.querySelector(fieldClass).classList.contains('is-required')) {
                field.querySelector(fieldClass).classList.add('is-required');
              }
            }
          }
        } else {
      ...
      // Validate custom fields (Twitter handle/email address)
      this.customValidationFields.forEach(function (field) {
        var validationField = field.querySelector('input');
        var validationType = field.dataset.validation;
        var validationFieldValue = validationField.value;

        if (validationType === 'twitter') {
          if (_twitterText2.default.isValidUsername(validationFieldValue)) {
            // valid
            if (validationField.classList.contains('is-not-valid')) {
              validationField.classList.remove('is-not-valid');
            }
          } else {
            // not valid
            _this.isValid = false;
            if (!validationField.classList.contains('is-not-valid')) {
              validationField.classList.add('is-not-valid');
            }
          }
        } else if (validationType === 'email') {
          if ((0, _validateEmail2.default)(validationFieldValue)) {
            // valid
            if (validationField.classList.contains('is-not-valid')) {
              validationField.classList.remove('is-not-valid');
            }
      ...
      // Submit form or show error alert
      if (this.isValid) {
        // submit
        if (this.alertWrapper.classList.contains('is-visible')) {
          this.alertWrapper.classList.remove('is-visible');
        }
        this.handleSubmit();
      } else {
        // show error message
        if (!this.alertWrapper.classList.contains('is-visible')) {
          this.alertWrapper.classList.add('is-visible');
        }
      }
    }
  }, {
    ...
    value: function handleSubmit() {
      if (!this.submitUrl) {
        console.log('No submitUrl specified. Aborting.');
        return;
      }
      ...
      this.successWrapper.classList.remove('is-hidden');
      this.formWrapper.classList.add('has-been-submitted');
    }
  }, {
    key: 'init',
    value: function init() {
      this.submit.addEventListener('click', this.validateFields.bind(this), false);
    }
  }]);
  return F01Form;
}();

(0, _aem.registerComponent)('.f01', F01Form);

/***/ }),

/***/ "../content/jcr_root/apps/boilerplate-twitter/components/form/f01-form/webpack/index.scss":
...
/***/ "../content/jcr_root/apps/boilerplate-twitter/components/form/f02-form-section/webpack/index.js":
/***/ (function(module, exports, __webpack_require__) {

"use strict";


__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/form/f02-form-section/webpack/index.scss");

/***/ }),

/***/ "../content/jcr_root/apps/boilerplate-twitter/components/form/f02-form-section/webpack/index.scss":
/***/ (function(module, exports) {
...
/***/ "../content/jcr_root/apps/boilerplate-twitter/components/form/f03-form-group/webpack/index.js":
/***/ (function(module, exports, __webpack_require__) {

"use strict";


__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/form/f03-form-group/webpack/index.scss");

/***/ }),

/***/ "../content/jcr_root/apps/boilerplate-twitter/components/form/f03-form-group/webpack/index.scss":
/***/ (function(module, exports) {
...
/***/ "../content/jcr_root/apps/boilerplate-twitter/components/form/f04-form-text-field/webpack/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/form/f04-form-text-field/webpack/index.scss");
...
var F04FormTextField = function () {
  function F04FormTextField(element, attributes) {
    (0, _classCallCheck3.default)(this, F04FormTextField);

    this.element = element;
    this.field = element.querySelector('.f04__field');
    this.closeBtn = element.querySelector('.f04__button--close');
    this.isValid = true;
    this.customValidation = element.dataset.validation;
    this.isRequired = element.classList.contains('is-required') ? true : false;
    this.metRequirements = false;
    this.form = document.querySelector('form');
    this.tooltip = element.querySelector('.f04__tooltip');
    this.tipBubble = element.querySelector('.f04__bubble-icon');
    this.tipBubbleMobile = element.querySelector('.f04__tooltip-bubble-mobile');
  ...
  (0, _createClass3.default)(F04FormTextField, [{
    key: 'doneValidating',
    value: function doneValidating() {
      if (this.customValidation) {
        // Twitter/email
        // not valid
        if (!this.isValid && !this.field.classList.contains('is-not-valid')) {
          this.field.classList.add('is-not-valid');
        }
        // valid
        if (this.isValid && this.field.classList.contains('is-not-valid')) {
          this.field.classList.remove('is-not-valid');
        }
        // valid
        if (this.isValid && this.field.classList.contains('is-required')) {
          this.field.classList.remove('is-required');
        }
      }

      if (this.isRequired) {
        // not valid
        if (!this.metRequirements && !this.field.classList.contains('is-not-valid')) {
          this.field.classList.add('is-not-valid');
        }
        // valid
        if (this.metRequirements && this.field.classList.contains('is-not-valid')) {
        ...
        // valid
        if (this.metRequirements && this.field.classList.contains('is-required')) {
          this.field.classList.remove('is-required');
        }
      }
    }
    ...
    /**
     * Validates Twitter handle or loosely validate email address.
     * Validates a required field.
     * @param  {string} str username/email address
     */

  }, {
    key: 'validate',
    value: function validate(str) {
      // validation for Twitter handle/email
      if (this.customValidation === 'twitter' || this.customValidation === 'email') {
        if (this.customValidation === 'twitter') {
          if (_twitterText2.default.isValidUsername(str)) {
            this.isValid = true;
          } else {
            this.isValid = false;
          }
        } else if (this.customValidation === 'email') {
          if ((0, _validateEmail2.default)(str)) {
            this.isValid = true;
          } else {
            this.isValid = false;
          }
      ...
      if (this.isRequired && this.customValidation) {
        // required and twitter/email
        if (str.length > 0 && this.isValid) {
          this.metRequirements = true;
        } else {
          this.metRequirements = false;
        }
      } else {
    ...
    value: function handleCloseClick() {
      ...
      if (this.field.classList.contains('is-valid')) {
        this.field.classList.remove('is-valid');
      }
      this.field.focus();

      // validate
      if (this.customValidation || this.isRequired) {
    ...
    value: function handleInput() {
      if (this.isValid && !this.field.classList.contains('is-valid')) {
        this.field.classList.add('is-valid');
      }

      if (!this.closeBtn.classList.contains('is-active')) {
        this.closeBtn.classList.add('is-active');
      }

      // validate email or twitter handle
      if (this.customValidation || this.isRequired) {
        this.validate(this.field.value);
      }
    }
    ...
    value: function handleBlur() {
      ...
      if (this.field.value === '' && this.field.classList.contains('is-valid')) {
        this.field.classList.remove('is-valid');
      }
    ...
    value: function handleFocus() {
      if (this.field.value !== '' && !this.closeBtn.classList.contains('is-active')) {
        this.closeBtn.classList.add('is-active');
      }
    }

    // Find instances of active tooltips and deactivate them

  }, {
    key: 'closeOtherTooltips',
    value: function closeOtherTooltips() {
      var activeTooltips = document.querySelectorAll('.f01__item .is-active');
      ...
      if (activeTooltips.length > 0) {
        ...
        try {
          for (var _iterator = (0, _getIterator3.default)(activeTooltips), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    key: 'handleTooltip',
    value: function handleTooltip(event) {
      event.preventDefault();

      var tipLine = this.element.querySelector('.f04__leader-line-icon');
      var tipCopy = this.element.querySelector('.f04__tooltip--copy');
      var tipMobileCopy = this.element.querySelector('.f04__tooltip-copy-mobile');

      if (!this.tooltip.classList.contains('is-active')) {
        this.closeOtherTooltips();

        this.tooltip.classList.add('is-active');
        this.tipBubble.classList.add('is-active');
        tipLine.classList.add('is-active');
        tipCopy.classList.add('is-active');
        tipMobileCopy.classList.add('is-active');
      } else {
        this.tooltip.classList.remove('is-active');
        this.tipBubble.classList.remove('is-active');
        tipLine.classList.remove('is-active');
        tipCopy.classList.remove('is-active');
        tipMobileCopy.classList.remove('is-active');
      }
    }
    ...
    value: function init() {
      // focus listener
      this.field.addEventListener('focus', this.handleFocus.bind(this), false);

      // blur listener
      this.field.addEventListener('blur', this.handleBlur.bind(this), false);

      // input listener
      this.field.addEventListener('input', this.handleInput.bind(this), false);

      // close button listeners
      this.closeBtn.addEventListener('mousedown', function (event) {
        event.preventDefault();
      }, false);

      this.closeBtn.addEventListener('click', this.handleCloseClick.bind(this), false);

      // tooltip click listener
      if (this.tooltip) {
        this.tipBubble.addEventListener('click', this.handleTooltip.bind(this), false);
        this.tipBubbleMobile.addEventListener('click', this.handleTooltip.bind(this), false);
      }
    }
  }]);
  return F04FormTextField;
}();

(0, _aem.registerComponent)('.f04', F04FormTextField);

/***/ }),

/***/ "../content/jcr_root/apps/boilerplate-twitter/components/form/f04-form-text-field/webpack/index.scss":
/***/ (function(module, exports) {
...
/***/ "../content/jcr_root/apps/boilerplate-twitter/components/form/f05-form-textarea/webpack/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/form/f05-form-textarea/webpack/index.scss");

var _aem = __webpack_require__("./source/aem.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var F05FormTextarea = function () {
  function F05FormTextarea(element, attributes) {
    (0, _classCallCheck3.default)(this, F05FormTextarea);

    this.element = element;
    this.textarea = element.querySelector('.f05__textarea');
    this.placeholderValue = null;
    this.isRequired = element.classList.contains('is-required') ? true : false;
    this.tooltip = element.querySelector('.f05__tooltip');
    this.tipBubble = element.querySelector('.f05__bubble-icon');
    this.tipBubbleMobile = element.querySelector('.f05__tooltip-bubble.is-mobile');
  ...
  (0, _createClass3.default)(F05FormTextarea, [{
    key: 'validate',
    value: function validate(str) {
      if (this.placeholderValue) {
        // Since the placeholder copy is actually the value of the textarea
        // we'll need to check and see if there's been a change to the value.
        if (this.placeholderValue === str) {
          // not valid
          if (!this.textarea.classList.contains('is-not-valid')) {
            this.textarea.classList.add('is-not-valid');
          }
        } else {
          // valid
          if (this.textarea.classList.contains('is-not-valid')) {
            this.textarea.classList.remove('is-not-valid');
          }
          if (this.textarea.classList.contains('is-required')) {
            this.textarea.classList.remove('is-required');
          }
        }
      } else {
        if (str.length === 0) {
    ...
    value: function blurHandler() {
      // The textarea is 'valid' when it is not empty
      if (this.textarea.value === '' && this.textarea.classList.contains('is-valid')) {
        this.textarea.classList.remove('is-valid');
      }

      // apply placeholder copy
      if (this.textarea.value === '' && this.placeholderValue !== null) {
        this.textarea.classList.add('has-placeholder');
        this.textarea.value = this.placeholderValue;
      }
    ...
    value: function focusHandler() {
      if (this.textarea.classList.contains('has-placeholder')) {
        this.textarea.classList.remove('has-placeholder');
        this.textarea.value = '';
      }
    }
    ...
    value: function inputHandler() {
      if (!this.textarea.classList.contains('is-valid')) {
        this.textarea.classList.add('is-valid');
      }
    ...
    value: function handleTooltip(event) {
      ...
      var tipLine = this.element.querySelector('.f05__leader-line-icon');
      var tipCopy = this.element.querySelector('.f05__tooltip-copy');
      var tipMobileCopy = this.element.querySelector('.f05__tooltip-copy-mobile');
    ...
    /**
     * Initialize event listeners
     * Add placeholder copy to textarea if it exists
     */

  }, {
    key: 'init',
    value: function init() {
      if (this.textarea.dataset.placeholder !== undefined) {
        this.placeholderValue = this.textarea.dataset.placeholder;
        this.textarea.value = this.placeholderValue;
        this.textarea.classList.add('has-placeholder');
      }

      // blur listener
      this.textarea.addEventListener('blur', this.blurHandler.bind(this), false);

      // input listener
      this.textarea.addEventListener('input', this.inputHandler.bind(this), false);

      // focus listener
      this.textarea.addEventListener('focus', this.focusHandler.bind(this), false);
  ...
  return F05FormTextarea;
}();

(0, _aem.registerComponent)('.f05', F05FormTextarea);

/***/ }),

/***/ "../content/jcr_root/apps/boilerplate-twitter/components/form/f05-form-textarea/webpack/index.scss":
/***/ (function(module, exports) {
...
/***/ "./source/core/js/validate-email/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
/**
 * Loose email vailidation. Regular expression origin: http://emailregex.com/
 *
...
__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/form/f01-form/webpack/index.js");
__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/form/f02-form-section/webpack/index.js");
__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/form/f03-form-group/webpack/index.js");
__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/form/f04-form-text-field/webpack/index.js");
module.exports = __webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/form/f05-form-textarea/webpack/index.js");
