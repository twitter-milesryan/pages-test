...
var _webFonts = __webpack_require__("./source/core/js/web-fonts/index.js");

var _webFonts2 = _interopRequireDefault(_webFonts);

__webpack_require__("./source/vendor-css.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

/*
  The app.js file loads after the DOM is rendered.
*/

__webpack_require__("./source/app.scss");

// Check ready state of document to initilize
...
// init asynchronous web font loading
...
/***/ "./source/core/js/web-fonts/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _cookies = __webpack_require__("./source/core/js/cookies/index.js");

var _cookies2 = _interopRequireDefault(_cookies);

var _webFonts = __webpack_require__("./source/core/variables/web-fonts.json");

var _webFonts2 = _interopRequireDefault(_webFonts);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var variables = _webFonts2.default['web-fonts'];

var html = document.documentElement;

var helveticaNeueLt400 = new _fontfaceobserver2.default('Helvetica Neue LT', {
  weight: 400
});

var helveticaNeueLt400Italic = new _fontfaceobserver2.default('Helvetica Neue LT', {
  weight: 400,
  style: 'italic'
});

var helveticaNeueLt700 = new _fontfaceobserver2.default('Helvetica Neue LT', {
  weight: 700
});

var webFonts = [loadFonts(helveticaNeueLt400, 'async-is-loaded--helveticaNeueLt400'), loadFonts(helveticaNeueLt400Italic, 'async-is-loaded--helveticaNeueLt400Italic'), loadFonts(helveticaNeueLt700, 'async-is-loaded--helveticaNeueLt700')];
...
function loadFonts(fontFamily, fontFamilyIsLoadedclassName) {
  return new _promise2.default(function (resolve, reject) {
    fontFamily.load().then(function (data) {
      html.classList.add(variables[fontFamilyIsLoadedclassName]);
      // reflect promise
      resolve({ success: true, data: data });
    }).catch(function (err) {
      html.classList.remove(variables['async-is-loading']);
      html.classList.add(variables['async-has-failed']);
      // reflect promise
...
function dispatchFonts() {
  // set 'is-loading' class on html element
  html.classList.add(variables['async-is-loading']);

  // reflect the promise so if one font fails the rest can continue,
  // otherwise they would all fail
  // http://stackoverflow.com/questions/31424561/wait-until-all-es6-promises-complete-even-rejected-promises/31424853
  _promise2.default.all(webFonts).then(function (results) {
    var success = results.filter(function (x) {
      return x.success;
    });

    if (!success.length) {
      // check length since an empty array will return 'true'
      return loadFailure();
    }
...
function loadSuccess() {
  ...
  // add is-loaded class
  html.classList.add(variables['async-is-loaded']);
...
function setCookie(value) {
  _cookies2.default.set('fontsLoaded', value, { expires: 1 });
}

/***/ }),

/***/ "./source/core/variables/web-fonts.json":
/***/ (function(module, exports) {

module.exports = {
	"web-fonts": {
		"fallback-family": "sans-serif",
		"async-is-loaded": "fonts-loaded",
		"async-is-loading": "fonts-loading",
		"async-has-failed": "fonts-failed",
		"async-is-loaded--helveticaNeueLt400": "fonts-loaded--helveticaNeueLt400",
		"async-is-loaded--helveticaNeueLt400Italic": "fonts-loaded--helveticaNeueLt400Italic",
		"async-is-loaded--helveticaNeueLt700": "fonts-loaded--helveticaNeueLt700"
	}
};
