...
/***/ "../content/jcr_root/apps/boilerplate-twitter/components/templates/t01-video/webpack/index.js":
...
var _plyr = __webpack_require__("./node_modules/plyr/src/js/plyr.js");
...
__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/templates/t01-video/webpack/index.scss");
__webpack_require__("./node_modules/plyr/dist/plyr.css");

// The custom T01VideoPlayer class can be used to customize functionality for each video player instance
var T01VideoPlayer = function () {
  function T01VideoPlayer(component, attributes) {
    (0, _classCallCheck3.default)(this, T01VideoPlayer);

    this.component = component;
    this.video = this.component.querySelector('video');
    this.videoPlayer = this.component.querySelector('.video_player');

    this.init();
  }

  (0, _createClass3.default)(T01VideoPlayer, [{
    key: 'init',
    value: function init() {
      var durationString = this.secondsToHms(this.video.duration);
      if (typeof durationString !== 'undefined') {
        this.component.querySelector('.plyr__time--duration').innerHTML = durationString;
        this.player = _plyr2.default.setup(this.video, this.videoPlayerConfig(durationString));
      }
      this.videoPlaceHolder = this.component.querySelector('.video__placeholder');

      if (this.videoPlaceHolder) {
        this.setVideoPlaceHolderHeight();
        window.addEventListener('resize', this.setVideoPlaceHolderHeight.bind(this), false);
      }
    }
  }, {
    key: 'controls',
    value: function controls(duration) {
      return [document.querySelector('.plyrCustomControls').innerHTML.replace("00:00", duration)].join("");
    }

    // Plyr.setup binds to all video players in the document and returns an array of references

  }, {
    key: 'videoPlayerConfig',
    value: function videoPlayerConfig(duration) {
      return {
        html: this.controls(duration),
        loadSprite: false
      };
    }
  }, {
    key: 'padTwo',
    value: function padTwo(number) {
    ...
    value: function secondsToHms(d) {
      ...
      return this.padTwo(hDisplay) + (hDisplay && (mDisplay || sDisplay) ? ':' : '') + this.padTwo(mDisplay) + ':' + this.padTwo(sDisplay);
    }
    ...
    key: 'getOuterHeight',
    value: function getOuterHeight(video) {
      var styles = window.getComputedStyle(this.videoPlayer);
      var elementMarginTop = parseFloat(styles['marginTop']);
      var elementMarginBottom = parseFloat(styles['marginBottom']);
      var elementHeight = video.offsetHeight;
      return elementMarginTop + elementHeight + elementMarginBottom;
    }
  }, {
    key: 'setVideoPlaceHolderHeight',
    value: function setVideoPlaceHolderHeight() {
      this.videoPlaceHolder.style.height = this.getOuterHeight(this.video) + 'px';
    }
  }]);
  return T01VideoPlayer;
}();

(0, _aem.registerComponent)('.t01__video', T01VideoPlayer);

/***/ }),

/***/ "../content/jcr_root/apps/boilerplate-twitter/components/templates/t01-video/webpack/index.scss":
...
/***/ "../content/jcr_root/apps/boilerplate-twitter/components/templates/t02-tweet/webpack/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/templates/t02-tweet/webpack/index.scss");

var _aem = __webpack_require__("./source/aem.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var T02VideoPlayer = function () {
  function T02VideoPlayer(element) {
    (0, _classCallCheck3.default)(this, T02VideoPlayer);

    this.gifPlayer = element.querySelector('.t02__video');
    this.playTrigger = element.querySelector('.js-play-trigger');

    this.playTrigger.addEventListener('click', this.handleVideoClick.bind(this));
  }

  (0, _createClass3.default)(T02VideoPlayer, [{
    key: 'handleVideoClick',
    value: function handleVideoClick(event) {
      event.preventDefault();

      if (this.gifPlayer.paused) {
        this.gifPlayer.play();
        this.playTrigger.classList.add('is-playing');
      } else {
        this.gifPlayer.pause();
        if (this.playTrigger.classList.contains('is-playing')) {
          this.playTrigger.classList.remove('is-playing');
        }
      }
    }
  }]);
  return T02VideoPlayer;
}();

(0, _aem.registerComponent)('.t02__video-player', T02VideoPlayer);

/***/ }),

/***/ "../content/jcr_root/apps/boilerplate-twitter/components/templates/t02-tweet/webpack/index.scss":
/***/ (function(module, exports) {
...
__webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/templates/t01-video/webpack/index.js");
module.exports = __webpack_require__("../content/jcr_root/apps/boilerplate-twitter/components/templates/t02-tweet/webpack/index.js");
